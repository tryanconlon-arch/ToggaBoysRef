# ToggaBoysRef Backlog

Rough notes — items captured but not yet scoped or fleshed out.
...
## Exploratory
- Is it possible to find records for single game weeks to distinguish from double game weeks?
  - Note: matchup period vs. scoring period is NOT the same distinction. User will define criteria later.
